...
/// Defines behavior for video stabilization
/// Applies video stabilization to the while recording - This mode doesn’t support pausing a recording
@property (nonatomic) BOOL supportVideoStabilization;
